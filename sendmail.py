...
if __name__ == '__main__':
    smtp = SMTP_SSL('smtp.office365.com',587)
    smtp.set_debuglevel(1)
    smtp.login("gaowei.yuan@netbraintech.com","Meteor.1")
    smtp.sendmail("gaowei.yuan@netbraintech.com", "gavin.yuan@netbraintech.com", "test email")
    smtp.quit()